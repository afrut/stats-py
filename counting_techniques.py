...
if __name__ == '__main__':
    ...
    # ----------------------------------------------------------------------
    n = 5
    print('The total number of different ways to arrange ' + str(n) +
    ...
    n = 5
    r = 3
    print('The total number of different ways to arrange ' + str(r) +
        ' different elements taken\nfrom a set of ' + str(n) + ' elements is:')
    ...
    n = 7
    r = 4
    print('The number of {0}-element combinations of {1} elements is:'\
        .format(r, n))
